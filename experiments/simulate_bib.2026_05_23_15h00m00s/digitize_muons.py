...
def write_local_digi_steer(local_filename: str):
    ...
    steer_text = steer_text.replace('"ResolutionU": ["0.007"]', '"ResolutionU": ["0.020"]')
    steer_text = steer_text.replace('"ResolutionV": ["0.090"]', '"ResolutionV": ["0.020"]')
    steer_text = steer_text.replace('"UseTimeWindow": ["true"]', '"UseTimeWindow": ["false"]')
    steer_text = steer_text.replace("1666", "99")
