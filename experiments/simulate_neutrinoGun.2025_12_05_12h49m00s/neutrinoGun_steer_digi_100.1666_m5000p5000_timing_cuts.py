...
if not the_args.enableBIB:
    Output_REC.Parameters = {
        ...
        "LCIOOutputFile": [f"./{the_args.TypeEvent}_digi_{the_args.InFileName}.slcio"],
...
InitDD4hep.Parameters = {
    "DD4hepXMLFile": [f"{the_args.code}/k4geo/MuColl/MAIA/compact/MAIA_v0/MAIA_v0.xml"],
...
InnerPlanarDigiProcessor.Parameters = {
    ...
    "TimeWindowMax": ["5000.0"],
    "TimeWindowMin": ["-5000.0"],
...
OverlayMIX.Parameters = {
    ...
    "Collection_IntegrationTimes": [
        "VertexBarrelCollection", "-5000.0", "5000.0",
        "VertexEndcapCollection", "-5000.0", "5000.0",
        "InnerTrackerBarrelCollection", "-5000.0", "5000.0",
        "InnerTrackerEndcapCollection", "-5000.0", "5000.0",
        "OuterTrackerBarrelCollection", "-5000.0", "5000.0",
        "OuterTrackerEndcapCollection", "-5000.0", "5000.0",
    ...
    "IntegrationTimeMin": ["-5000.0"],
    "MCParticleCollectionName": ["MCParticle"],
    "MergeMCParticles": ["false"],
    "NumberBackground": ["166"]
}
