...
OverlayMIX.Parameters = {
    ...
    "Collection_IntegrationTimes": [
        "VertexBarrelCollection", "-5.0", "5.0",
        "VertexEndcapCollection", "-5.0", "5.0",
        "InnerTrackerBarrelCollection", "-5.0", "5.0",
        "InnerTrackerEndcapCollection", "-5.0", "5.0",
        "OuterTrackerBarrelCollection", "-5.0", "5.0",
        "OuterTrackerEndcapCollection", "-5.0", "5.0",
