...
# run
# time python ${CODE}/maia_noodling/python/digitize_muons.py --gen --sim --digi --bib --num ${1} --data ${DATA} --typeevent neutrinoGun
time python ${CODE}/maia_noodling/python/digitize_muons.py --digi --bib --num ${1} --data ${DATA} --typeevent neutrinoGun
