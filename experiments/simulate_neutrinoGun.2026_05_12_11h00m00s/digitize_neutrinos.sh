...
DATA=${CODE}/maia_noodling/experiments/simulate_bib.2026_04_21_16h00m00s
...
# run
time python digitize_muons.py --gen --sim --digi --bib --num ${1} --data ${DATA} --typeevent ${TYPEEVENT}
